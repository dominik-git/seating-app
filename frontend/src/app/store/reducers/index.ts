...
export const getParkingPlace = createSelector(
  getAppState,
  fromApp.selectParkingPlace
);
export const getDeskPlace = createSelector(
  getAppState,
  fromApp.selectDeskPlace
);
...
export const getSpinner = createSelector(
  getLoadingState,
  fromLoading.selectLoadingState
);
...
export const getSelectedDesk = createSelector(
  getBookingState,
  fromBooking.selectedDeskState
);
...
export const getSelectedPlace = createSelector(
  getAdminState,
  fromAdmin.selectSelectedPlace
);
export const getFixedPlaces = createSelector(
  getAdminState,
  fromAdmin.selectFixedPlaces
);
