...
export function apiBookingPost$Json(http: HttpClient, rootUrl: string, params?: ApiBookingPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<BookingPlaceViewModel>> {
