...
export function apiBookingGetByBookingPlaceIdWithDateIdGet$Json(http: HttpClient, rootUrl: string, params: ApiBookingGetByBookingPlaceIdWithDateIdGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<BookingPlaceWithBookingsViewModelBaseResponse>> {
